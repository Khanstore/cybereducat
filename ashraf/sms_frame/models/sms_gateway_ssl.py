...
class SmsGatewaySSL(models.Model):
    ...
    def send_message(self, sms_gateway_id, from_number, to_number, sms_content, my_model_name='', my_record_id=0,
        ...
        # send the sms/mms
        payload = {"sms[0][0]": format_to, "sms[0][1]": sms_content, sms_account.param_sid: sms_account.sid,
                   sms_account.param_user: sms_account.user, sms_account.param_pass: sms_account.password}
...
#     twilio_last_check_date = fields.Datetime(string="Last Check Date")
    ...
    #     response_string = requests.get("https://api.twilio.com/2010-04-01/Accounts/" + self.twilio_account_sid,
    ...
    #             "https://api.twilio.com/2010-04-01/Accounts/" + self.twilio_account_sid + "/IncomingPhoneNumbers",
    #             auth=(str(self.twilio_account_sid), str(self.twilio_auth_token)))
    #
    ...
    #                     {'name': av_phone, 'mobile_number': av_phone, 'account_id': self.id})
    #
    #             payload = {'SmsUrl': str(request.httprequest.host_url + "sms/twilio/receive")}
    #             requests.post(
    #                 "https://api.twilio.com/2010-04-01/Accounts/" + self.twilio_account_sid + "/IncomingPhoneNumbers/" + sid,
    #                 data=payload, auth=(str(self.twilio_account_sid), str(self.twilio_auth_token)))
    #
